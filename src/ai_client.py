...
class AIClient:
    ...
    async def generate_response(self, context_messages: List[dict], user_message: str, mentioned_by: str) -> Optional[str]:
        """
        ...
        try:
            ...
            formatted_context = self._format_context_for_ai(context_messages, user_message, mentioned_by)
    ...
    def _format_context_for_ai(self, context_messages: List[dict], user_message: str, mentioned_by: str) -> str:
    ...
    async def _generate_with_gemini(self, formatted_context: str) -> Optional[str]:
        ...
        try:
            ...
            config = types.GenerateContentConfig(
                ...
                max_output_tokens=min(Config.AI_MAX_TOKENS, 2000),  # Keep Discord responses reasonable
